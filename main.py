...
from cadastrarVisitantes import Ui_janelaCadastrarVisitantes
...
class Home(QMainWindow):
    ...
    def __init__(self,*args,**argvs):
        ...
        self.ui.btnActNovoVisitante.triggered.connect(self.abrirCadastrarVisitantes)
    ...
    def abrirCadastrarVisitantes(self):
        self.janela = GuiaCadastrarVisitantes()
        self.janela.show()
...
class GuiaCadastrarVisitantes(QMainWindow): #Contrui a janela aqui, e chamei a page externa pra ligar com essa
    def __init__(self,*args,**argvs):
        super(GuiaCadastrarVisitantes,self).__init__(*args,**argvs)
        self.telaCadastrarVisitantes = Ui_janelaCadastrarVisitantes()
        self.telaCadastrarVisitantes.setupUi(self)
