...
#Para inserir dados na tabela  
    ...
    def atualizarMoradores(self, newDataNasc, newNumApt, newBloco, newTipoMorador, newTel, newEmail, newApelido, newSenha, newVaga, newStatus, newTipoVei, newModelo, newCorVei, newPlaca, newNomeMorador, nomeMorador, cpfMorador):
        ...
        queryAtualizacao = "UPDATE tbl_pessoa JOIN tbl_moradia ON tbl_pessoa.id_pessoa = tbl_moradia.tbl_pessoa_id_pessoa1 JOIN tbl_veiculo ON tbl_moradia.id_moradia = tbl_veiculo.tbl_moradia_id_moradia "\
                            ...
                            "modelo_vei ='%s', cor_vei ='%s', placa_vei ='%s', nome_pessoa ='%s' WHERE nome_pessoa ='%s' OR cpf_pessoa='%s';" % (newDataNasc, newNumApt, newBloco, newTipoMorador, newTel, newEmail, newApelido, newSenha, newVaga, newStatus, newTipoVei, newModelo, newCorVei, newPlaca, newNomeMorador, nomeMorador, cpfMorador)
