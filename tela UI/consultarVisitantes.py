...
class Ui_janelaConsultarVisitantes(object):
    ...
    def funCarregarVisi(self):
        ...
        query = "SELECT nome_visi, CASE autorizado WHEN FALSE THEN 'NÃO' ELSE 'SIM' END autorizado, num_ap, bloco_ap, CASE data_fim_visi WHEN !NULL THEN data_fim_visi ELSE 'Sem limite' "\
                "END data_fim_visi, rg_visi, dt_registro_visi FROM visi_apt JOIN agen_visi ON visi_apt.id_visi = agen_visi.visi_apt_id_visi JOIN tbl_pessoa ON "\
                    "agen_visi.tbl_pessoa_id_pessoa = tbl_pessoa.id_pessoa JOIN tbl_moradia ON tbl_pessoa.id_pessoa = tbl_moradia.tbl_pessoa_id_pessoa1 WHERE nome_pessoa='Davi da Silva';"
